...
namespace TOPV_Dispenser.MVVM.ViewModels
{
    public class VisionAutoViewModel : PropertyChangedNotifier
    {
        ...
        private void BotCamera_GrabFinished(object sender, CGrabResult grabResult)
        {
            ...
            {
                lock (CDef.BotCamera.GrabResult.GrabImage)
                {
                    if (CDef.BotCamera.GrabResult.GrabImage == null
                        || CDef.BotCamera.GrabResult.GrabImage.IsDisposed
                        || CDef.BotCamera.GrabResult.GrabImage.Empty())
                    {
                        return;
                    }

                    // Display Grab Image
                    OutputMat_BOT = CDef.BotCamera.GrabResult.GrabImage.Clone();

                    if (CDef.BotCamera.IsLive == false)
                    {
        ...
        private void TopCamera_GrabFinished(object sender, CGrabResult grabResult)
        {
            ...
            {
                lock (CDef.TopCamera.GrabResult.GrabImage)
                {
                    if (CDef.TopCamera.GrabResult.GrabImage == null
                        || CDef.TopCamera.GrabResult.GrabImage.IsDisposed
                        || CDef.TopCamera.GrabResult.GrabImage.Empty())
                    {
                        return;
                    }
                    ...
                    if (CDef.TopCamera.GrabTarget == "GrabTop")
                    {
                        if (CDef.TopCamera.IsLive == false)
                        {
                            // Set input image in grab mode
                            LoadVisionProcess.InputMat = CDef.TopCamera.GrabResult.GrabImage.Clone();
                        }

                        // Display Grab Image
                        OutputMat_TOP = CDef.TopCamera.GrabResult.GrabImage.Clone();
                    }
                    else if (CDef.TopCamera.GrabTarget == "GrabBase")
                    {
                        ...
                        {
                            // Set input image in grab mode
                            UnloadVisionProcess.InputMat = CDef.TopCamera.GrabResult.GrabImage.Clone();
                            InspectVisionProcess.InputMat = CDef.TopCamera.GrabResult.GrabImage.Clone();
                        }

                        // Display Grab Image
                        OutputMat_BASE = CDef.TopCamera.GrabResult.GrabImage.Clone();
                    }
                }
            }
        }
