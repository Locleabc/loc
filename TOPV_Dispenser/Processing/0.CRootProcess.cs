...
namespace TOPV_Dispenser.Processing
{
    public partial class CRootProcess : ProcessingBase
    {
        ...
        public CDispenserProcess HeadLeftProcess { get; set; }
        public CDispenserProcess HeadRightProcess { get; set; }
        ...
        public void InitProcess()
        {
            ...
            HeadLeftProcess = new CDispenserProcess(this, "HeadL", MessageCode + 1000, IntervalTime = this.IntervalTime + 5, EHead.HEAD_Left);
            HeadRightProcess = new CDispenserProcess(this, "HeadR", MessageCode + 2000, IntervalTime = this.IntervalTime + 5, EHead.HEAD_Right);

            Childs = new ObservableCollection<IProcessing>();

            this.Childs.Add(HeadLeftProcess);
            this.Childs.Add(HeadRightProcess);
        }
        #endregion
